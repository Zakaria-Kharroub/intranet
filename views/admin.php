                    ...
                    <?php  foreach ($users as $user) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="index.php?action=deleteApprenant" method="post" style="display: inline-block;">
                        ...
                        <div class="modal fade" id="updateModal<?php echo $user['id_utilisateur']; ?>" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="index.php?action=updateApprenant" method="POST">
                                                    <input type="hidden" name="id_utilisateur" value="<?php echo $user['id_utilisateur']; ?>">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">ajouter appranant</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="index.php?action=ajouterApprenant" method="POST">
                <div class="modal-body">
